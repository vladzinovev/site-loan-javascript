  ...
  _createClass(Difference, [{
    ...
    value: function init() {
      try {
        ...
        this.bindTriggers(this.newOfficer, this.newItems, this.newCounter); // this.Proverka(this.oldOfficer, this.oldItems,this.newOfficer, this.newItems,this.number1,this.number2);
      } catch (e) {}
    }
  }]);
